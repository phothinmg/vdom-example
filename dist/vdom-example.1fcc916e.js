...
var _indexDefault = parcelHelpers.interopDefault(_index1);
(0, _index.render)((0, _indexDefault.default), document.getElementById("app"));

},{"./lib/index":"iLkgj","./components/index":"9q5R2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"iLkgj":[function(require,module,exports,__globalThis) {
/**
...
parcelHelpers.export(exports, "ce", ()=>ce);
/**
 * Create VTextNode
 * @param {string} txt
 ...
 */ function parseattr(el, attr) {
    ...
    if (keys.length > 0) keys.forEach((key)=>{
        const val = key === "style" ? `${attr[key].join(";")};` : key === "class" ? attr[key].join(" ") : attr[key];
 ...
 */ function parseVnode(node) {
    ...
    if (node.children.length > 0) for (const child of node.children)el.appendChild(parseChildNode(child));
    return el;
}
/**
...
},{}],"9q5R2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _index = require("../lib/index");
...
const App = (0, _index.ce)("main", {
    children: [
        ...
        (0, _bodyDefault.default),
        (0, _footerDefault.default)
    ]
});
exports.default = App;

},{"../lib/index":"iLkgj","./header":"be1w4","./body":"lBb9z","./footer":"9XP3q","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"be1w4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _index = require("../lib/index");
const Header = (0, _index.ce)("header", {
    children: [
        (0, _index.ce)("nav", {
            attr: {
                class: [
...
},{"../lib/index":"iLkgj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lBb9z":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _index = require("../lib/index");
const Body = (0, _index.ce)("div", {
    children: [
        (0, _index.ce)("p", {
            children: [
                {
...
},{"../lib/index":"iLkgj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9XP3q":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _index = require("../lib/index");
const Footer = (0, _index.ce)("footer", {
    children: [
        (0, _index.ce)("hr", {}),
        (0, _index.ce)("h5", {
            children: [
...
},{"../lib/index":"iLkgj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["iUuJv","fILKw"], "fILKw", "parcelRequiree7fb", {})

//# sourceMappingURL=vdom-example.1fcc916e.js.map
